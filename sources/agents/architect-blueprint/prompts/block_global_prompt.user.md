...
<RULE>
You MUST dynamically and contextually generate a comprehensive architectural compliance specification paragraph for each item below, fully translated into the language matching {{ target_language }}:
...
<RULE>
You MUST dynamically and contextually generate a continuous deployment flow description paragraph for each item below, fully translated into the language matching {{ target_language }}:
