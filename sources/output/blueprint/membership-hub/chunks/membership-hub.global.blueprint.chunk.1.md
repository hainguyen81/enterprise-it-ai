...
- **GLOBAL AUTOMATIC TERMINATION BOUNDARY:** Your very first emitted token MUST be the first visible markdown header line rendered in this active User Message. The exact microsecond you finish printing the last visible data row or string before the active segment's closing HTML framework tag (e.g., `<!--END_...-->`, example: `<!--END_PART_1_INITIAL-->`), you MUST trigger an immediate hard stop and terminate the response stream instantly.
...
| Item | Details |
| :--- | :--- |
| **Blueprint ID** | ARCH-20260817042313 |
| **Project Name** | membership-hub |
| **Version** | 1.0 (Baseline) |
| **Date.Time** | 2026/08/17 04:23:13 |
