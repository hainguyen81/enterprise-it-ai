...
- You are strictly commanded to ONLY generate Section 5 (GRANULAR PROGRESSIVE IMPLEMENTATION DAYLOG) specialized exclusively for Phase 2.
...
- **RAW EMISSION RAIL:** You MUST NOT wrap your response inside triple backticks (```markdown ... ```). Start your stream immediately with the literal string `### Phase 2 - [Translated Phase Title]` followed directly by your localized specifications.
- **BOUNDED TIMELINE GATE:** You MUST open the daylog section exactly with the tag `<!--START_DAY_LOG_INDEX_2-->` and you MUST close the response exactly with the tag `<!--END_PHASE_LOG_BLOCK_INDEX_2-->`. 
...
### [Translate the word \"Phase\" into target language] 2 - [EMIT_TRANSLATED_SECTION_4_2_OBJECTIVE_STRING_HERE]
