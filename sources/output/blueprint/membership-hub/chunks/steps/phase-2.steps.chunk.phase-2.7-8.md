...
```json
{
  ...
  "objectives": "Xây dựng nền tảng bảo mật và quản trị cốt lõi: hoàn thiện luồng xác thực email/mật khẩu và OAuth2 với Firebase, Google, Facebook kèm JWT 15 phút và refresh token 7 ngày; triển khai hệ thống phân quyền RBAC 5 cấp thông qua bộ lọc bảo mật Quarkus; xây dựng module quản lý trung tâm với CRUD đầy đủ và cơ chế phát hiện xung đột mã số thuế; đồng thời khởi tạo bộ tài liệu kỹ thuật doanh nghiệp gồm blueprint tổng thể, ma trận phân quyền và sổ tay vận hành nhằm phục vụ kiểm toán và bàn giao.",
  "project_name": "membership-hub",
  "global_context_file": ".ai/.context/membership-hub.global.blueprint.md",
  "source_target_dir": "sources/",
  "days": []
