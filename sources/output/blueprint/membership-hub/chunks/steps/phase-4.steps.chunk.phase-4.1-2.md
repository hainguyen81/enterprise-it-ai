  ...
  "days": [
    {
      ...
      "context_section": "Khởi tạo và xây dựng giao diện ứng dụng di động Next.js hỗ trợ theo vai trò người dùng và tài liệu kỹ thuật nền tảng",
      "sub_tasks": [
        {
          "id": "D1_ST1",
          "agent": "Coder",
          "desc": "Khởi tạo cấu hình package.json cho ứng dụng frontend Next.js, xây dựng các thành phần giao diện tương thích với từng vai trò người dùng (Student, Teacher, Admin, Center Admin, Manager) kèm theo các phụ thuộc React và Tailwind CSS.",
          "targeted_tags": [
            "[REQ-020]",
            "[REQ-021]",
            "[ARC-009]"
        ...
        },
        {
          "id": "D1_ST2",
          "agent": "Doc",
          "desc": "Khởi tạo và biên soạn tài liệu hướng dẫn sử dụng chi tiết dành cho Center Admin về cách xem bảng điều khiển và xuất báo cáo CSV, kèm hướng dẫn sử dụng ứng dụng di động cho học viên và giáo viên, đảm bảo tuân thủ quy chuẩn gói org.nlh4j.membershiphub lưu trữ tại ./sources/docs/.",
          "targeted_tags": [
            "[DOC-001]",
            "[REQ-020]",
            "[REQ-024]"
          ...
          "components": [
            ...
            "./sources/docs/user_manual_and_reports.md"
          ]
        }
      ]
    },
    {
      "day": 2,
      "context_file": ".ai/.plan/.context/phase-4.context.blueprint.md",
      "context_section": "Tích hợp chatbot AI dịch vụ khách hàng hỗ trợ giải đáp thắc mắc tự động",
      "sub_tasks": [
        {
          "id": "D2_ST1",
          "agent": "Coder",
          "desc": "Xây dựng endpoint REST trong Quarkus tích hợp mô hình ngôn ngữ lớn để xử lý các truy vấn phổ biến của người dùng về khóa học, giáo viên, trung tâm và trạng thái tài khoản, đảm bảo phản hồi nhanh chóng và chính xác. API Contract: {\"endpoint\": \"/api/v1/chatbot/query\", \"method\": \"POST\", \"request\": {\"userId\": \"uuid\", \"query\": \"string\"}, \"response\": {\"answer\": \"string\", \"confidence\": \"float\"}}",
          "targeted_tags": [
            "[REQ-019]"
          ],
          "components": [
            "./sources/backend/courseService/src/main/java/org/nlh4j/membershiphub/courseservice/AiChatbotResource.java"
          ]
        }
      ]
    }
